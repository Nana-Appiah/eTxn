...
{
    [Keyless]
    public partial class ViewArPropertyJoined
    {
        [Column("ObjectID")]
        ...
        [StringLength(255)]
        public string PropertyObjectTypeNamespace { get; set; }
        [StringLength(255)]
        public string PropertyObjectTypeAlias { get; set; }
        [StringLength(255)]
        public string PropertyObjectTypeName { get; set; }
    }
}